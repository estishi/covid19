  ...
  return (
      ...
      <table className='countryTable'>
        <tbody>
          <tr>
          <td>  <h4>ALL DEATHS</h4>
            <h5>{numberWithCommas(isCountry?.latest_data.deaths)}</h5></td>
          <td>
          ...
          <td>  <h4>CASES PER MILLION</h4>
            <h5>{numberWithCommas(isCountry?.latest_data.calculated.cases_per_million_population)}</h5></td>
          </tr>
        </tbody>
      </table>
